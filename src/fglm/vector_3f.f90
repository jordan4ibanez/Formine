...
contains
  ...
  type(vec3f) function constructor_scalar(i) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function constructor_raw(x1,y1,z1) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function constructor_array(xyz_array) result(vec3f_new)
    implicit none

    real(c_float), dimension(3), intent(in) :: xyz_array

    vec3f_new = xyz_array(1:3)
  end function constructor_array


  !* Only use this for translating vec3d into vec3f on the stack.
  type(vec3f) function constructor_vec3d(input_vec3d) result(vec3f_new)
    use :: vector_3d
    implicit none

    type(vec3d), intent(in), value :: input_vec3d

    vec3f_new = input_vec3d
  ...
  type(vec3f) function add_scalar_f32(this, i) result(vec3f_new)
    implicit none

    class(vec3f), intent(in) :: this
    real(c_float), intent(in), value :: i

    vec3f_new%x = this%x + i
    vec3f_new%y = this%y + i
    vec3f_new%z = this%z + i
  end function add_scalar_f32


  type(vec3f) function add_array_f32(this, arr) result(vec3f_new)
    implicit none

    class(vec3f), intent(in) :: this
    real(c_float), dimension(3), intent(in) :: arr

    vec3f_new%x = this%x + arr(1)
    vec3f_new%y = this%y + arr(2)
    vec3f_new%z = this%z + arr(3)
  end function add_array_f32


  type(vec3f) function add_vec3f(this, other) result(vec3f_new)
    implicit none

    class(vec3f), intent(in) :: this
    type(vec3f), intent(in), value :: other

    vec3f_new%x = this%x + other%x
    vec3f_new%y = this%y + other%y
    vec3f_new%z = this%z + other%z
  ...
  type(vec3f) function subtract_scalar_f32(this, i) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function subtract_array_f32(this, arr) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function subtract_vec3f(this, other) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function multiply_scalar_f32(this, i) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function multiply_array_f32(this, arr) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function multiply_vec3f(this, other) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function divide_scalar_f32(this, i) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function divide_array_f32(this, arr) result(vec3f_new)
    implicit none
  ...
  type(vec3f) function divide_vec3f(this, other) result(vec3f_new)
    implicit none
  ...
  function as_array(this) result(array_new)
    ...
    class(vec3f), intent(in) :: this
    real(c_float), dimension(3) :: array_new
